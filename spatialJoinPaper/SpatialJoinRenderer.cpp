...
namespace osc {
    ...
    void SpatialJoinRenderer::render(const TriangleMesh& model1, const TriangleMesh& model2, const int launchDim, std::ofstream& outFile)
    {
        ...
        launchParams.traversable1 = buildGAS(model1, vertexBuffer1, indexBuffer1, asBuffer1);
        launchParams.traversable2 = buildGAS(model2, vertexBuffer2, indexBuffer2, asBuffer2);
    ...
    OptixTraversableHandle SpatialJoinRenderer::buildGAS(const TriangleMesh &model, CUDABuffer &vertexBuffer, CUDABuffer &indexBuffer, CUDABuffer &asBuffer)
    {
